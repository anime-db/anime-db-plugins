...
Хост сам подключает перечисленные там файлы на страницу плагина — подключать их из
разметки плагина не нужно (и нечем: у плагина нет собственного шаблона страницы). Поле
